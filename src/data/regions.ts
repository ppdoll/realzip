 ...
 * 일반구가 있는 시(수원/성남/고양/용인/부천/화성/창원/청주/천안 등)는 시 코드가 아니라
 * **구 단위 코드**를 써야 실거래 데이터가 나온다. 시 코드로 부르면 오류가 아니라
 * **0건**이 돌아와서 조용히 빈 지역이 된다 — 서울·경기 일괄 적재 중 부천(41190)과
 * 화성(41590)이 실제로 이렇게 걸렸다. 새 지역을 넣으면 `npm run probe` 로 확인할 것.
 *
...
export const REGIONS: Region[] = [
  ...
  // 부천시는 2024.1.1 일반구 재설치 — 41190(시 코드)은 실거래가 API 가 0건을 준다.
  { code: '41192', sido: '경기도', name: '부천시 원미구' },
  { code: '41194', sido: '경기도', name: '부천시 소사구' },
  { code: '41196', sido: '경기도', name: '부천시 오정구' },
  ...
  // 화성시는 2026.2.1 일반구 4개 개청 — 41590(시 코드)은 0건이다.
  // 구 배정은 법정동으로 확인했다: 만세(남양·우정·향남읍), 효행(봉담읍·비봉·정남면),
  // 병점(진안·병점·반월·안녕동), 동탄(반송·석우·청계·영천동).
  { code: '41591', sido: '경기도', name: '화성시 만세구' },
  { code: '41593', sido: '경기도', name: '화성시 효행구' },
  { code: '41595', sido: '경기도', name: '화성시 병점구' },
  { code: '41597', sido: '경기도', name: '화성시 동탄구' },
